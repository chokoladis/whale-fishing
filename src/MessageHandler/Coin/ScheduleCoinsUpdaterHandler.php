...
#[AsMessageHandler]
class ScheduleCoinsUpdaterHandler
{
    ...
    public function __invoke(ScheduleCoinsUpdaterMessage $message): void
    {
        try {
            ...
            $this->logger->emergency('throw in schedule coins handler', [$e->getMessage(), $e->getTraceAsString()]);
            return;
        }
