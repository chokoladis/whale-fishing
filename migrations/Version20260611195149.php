...
final class Version20260611195149 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE wallet_coin (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, balance NUMERIC(28, 8) NOT NULL, avg_price NUMERIC(28, 8) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, wallet_id INT NOT NULL, coin_id INT NOT NULL, PRIMARY KEY (id))');
