...
class TokenServiceTest extends TestCase
{
    ...
    public function test_getNewAccessToken_success()
    {
        ...
        $this->refreshToken->expects(self::once())->method('isRevoked')->willReturn(false);
        $this->refreshToken->expects(self::once())->method('getExpiredAt')->willReturn(new \DateTimeImmutable('+1 day'));
    ...
    {
        $obj = new User();
        $obj->setEmail(self::DEFAULT_EMAIL);
